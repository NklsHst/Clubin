class Location < ApplicationRecord
  ...
  def calculate_average_atmosphere
    ...
    check_ins.pluck(:atmosphere_rating).sum/check_ins.length unless check_ins.pluck(:atmosphere_rating).any?{ |e| e.nil? }

  end

  def calculate_average_queue
    check_ins = self.check_ins
    check_ins.pluck(:queue_rating).sum/check_ins.length unless check_ins.pluck(:queue_rating).any?{ |e| e.nil? }
  end
